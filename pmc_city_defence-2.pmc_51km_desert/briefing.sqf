...
switch (side player) do
{
	case WEST:
	{
		...
		player createDiaryRecord ["Diary",["ORDERS","1-1-A team <marker name='start'>start</marker> from city. Defend this citys southern district at all cost. Mission is accomplished when all enemies have been neutralized."]];
