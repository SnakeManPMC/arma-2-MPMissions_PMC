...
Syntax:
[] execVM "PMC\PMC_Aircraft_OPFOR.sqf";
...
//	_vcl = _myVec createVehicle (getPosASL pmc_opfor_start_1);
	...
	"TK_Soldier_Pilot_EP1" createUnit [_respawnpoint, _grp, "", 1, "SERGEANT"];
...
while {PMC_aircraft_opfor_running} do
{
	...
	_vcl = [_targetpoint, _respawnpoint] call _PMC_Aircraft_OPFOR;
