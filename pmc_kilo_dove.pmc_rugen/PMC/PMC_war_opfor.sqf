...
private ["_PMC_MakeAttackInfOPFOR","_respawnpoint","_targetpoint","_victoryCondition","_sleeptime"];

// position where enemy troops are created
...
_PMC_MakeAttackInfOPFOR = compile preProcessFileLineNumbers "PMC\PMC_Create_Attack_OPFOR.sqf";
...
while {PMC_opfor < _victoryCondition} do
{
	...
	{
		[_targetpoint, _respawnpoint] call _PMC_MakeAttackInfOPFOR;
